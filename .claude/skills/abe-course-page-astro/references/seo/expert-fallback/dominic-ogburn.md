...
| Role | Course Developer (CEO and Course Developer — ABE Education) |
| Organisation | ABE Education |
| Profile Page URL | `/experts/dominic-ogburn` (no trailing slash) |
| Person schema `@id` | `https://www.abeeducation.edu.au/experts/dominic-ogburn/#person` |
| Headshot URL | `https://lwfiles.mycourse.app/638d2798a130a8e77268b848-public/f13e5463746db5554514e16b0804ce41.png` (✅ set) |
...
| Course | Live URL | Course role | Last review date | Status |
|---|---|---|---|---|
| ACT Owner Builder | `/act-owner-builder-course` | Course developer | 14 April 2026 | ✅ Live |
| WA Owner Builder | `/wa-owner-builder-course` | Course developer — meets WA LGIRS Form 75 knowledge requirements. URL: standard `{state}-owner-builder-course` convention. | 14 April 2026 | ✅ Live |
| QLD Owner Builder | `/qld-owner-builder-course` | Course developer · delivered directly by ABE Education as an approved QBCC owner-builder course provider | 14 April 2026 | ✅ Live |
| CPD Courses (hub + state) | Hub `/cpd` · `/cpd-nsw`, `/cpd-tas`, `/cpd-wa` | Course developer — meets Building Commission NSW CPD criteria (NSW; formerly NSW Fair Trading) and CBOS requirements (TAS) | 14 April 2026 | ✅ Live |
...
**Long (400 words):** *(use on profile hero / dedicated About section)*
...
**Credential pills (hero/skill-pill sections):** Licensed NSW Builder · Minister's Award 2005 · Standards Australia BD-038 · Published Author — Allen & Unwin · Parliamentary Citation · 40+ Years Experience · 31,000+ Students Trained · 5 Government Jurisdictions

**Inline attribution (within course body):**
...
**5-jurisdictions (hub and profile bios):**
> Since 2007, as CEO of ABE Education, Dominic has developed owner builder and CPD training completed by 31,000+ students across five jurisdictions — owner builder approved by Access Canberra (ACT) and CBOS (Tasmania), delivered directly by ABE Education as an approved QBCC provider in Queensland, and meeting WA LGIRS Form 75 knowledge requirements; and CPD meeting Building Commission NSW's criteria for builders and swimming pool builders. (The NSW Owner Builder course is delivered by our RTO partner Upskill Institute (RTO 45708) and is not developed by Dominic.)

**Scope boundary (hub S6 / About / course attribution):**
> Owner builder and CPD courses ABE delivers directly (QLD, WA, TAS and ACT owner builder; CPD) are developed by Dominic Ogburn. White Card, asbestos awareness, and the NSW Owner Builder course are delivered by our RTO partners — Blue Dog Training (RTO 31193), AlertForce (RTO 91826), or Upskill Institute (RTO 45708). Every ABE-published course page is independently reviewed for currency by Warwick Smith.

---

## Verified credentials (16) — summary

1. **NSW Builder's Licence 369417C** — CURRENT (expires June 2027), Contractor Licence; clean record. Now administered by **Building Commission NSW** (NSW builder licensing moved from NSW Fair Trading to Building Commission NSW). Say "Licensed NSW builder", not "former" or "registered".
2. **2005 NSW Fair Trading Minister's Award for Consumer Advocacy** — say "NSW government award winner"; not "award-winning builder" / "multiple awards" (only one).
3. **Standards Australia BD-038 Committee Member** — developed AS 3740-2010. Member, NOT chairman/author.
4. **Published author** — *Your Home: Buying, Selling, Renovating, Building* (Allen & Unwin, 2004, ISBN 1865088919, NLA 3067415), co-author Harvey Grennan. Not "bestselling"; not the wrong title "99 Q&As From The Experts".
5. **Government approvals — 5 jurisdictions:** WA (LGIRS Form 75 knowledge model — LGIRS was formerly DEMIRS, renamed 1 July 2025), TAS (CBOS approved provider), ACT (Access Canberra approved), QLD (QBCC — ABE is an approved owner-builder course provider), NSW (Building Commission NSW CPD criteria — building/CPD functions formerly NSW Fair Trading, transferred 1 December 2023; self-declaration + audit, no provider approval). Note: the **NSW Owner Builder** course is delivered by Upskill Institute (RTO 45708), not developed by Dominic. See canonical/forbidden phrasings.
6. **Cited in NSW Parliament Hansard (2001)** — NSW Legislative Council, 27 March 2001 (HIH/Home Warranty debate). "Cited", not "testified".
7. **Senate Select Committee submission (1995)** — Aircraft Noise in Sydney; property-value study. "Submitted written evidence", not "called to give evidence".
8. **Sydney Morning Herald — 6 confirmed articles (1995–2018).** "Featured/cited", not "regular contributor".
9. **AEES Newsletter 3/2001 (Institution of Engineers Australia)** — reproduced "Towers of Trouble". "Referenced in", not "member".
10. **Experience — 40+ years** (from March 1980). Not "50 years".
11. **Clean regulatory record** — zero disciplinary actions.
12. **31,000+ students trained** since ABE founded May 2007 (LearnWorlds LMS records).
13. **Australian Financial Review (2002)** — URL confirmed; ⚠️ content pending paywall verification — do NOT publish until verified.
14. **Access Property Inspections (~1987–2007)** — Petersham NSW; predates ABE by ~20 years.
15. **CHOICE Magazine featured expert (2011)** — house energy ratings investigation + Kozicki case study. "Featured/quoted", not "endorsed/recommended".
16. **Stuart Brothers Pty Ltd — 11 years (1980–1991)** — rose to Senior Construction Manager (projects to $11M). Employee, not founder/CEO/partner.
...
```json
{
  ...
  "mainEntity": {
    ...
    "image": "https://lwfiles.mycourse.app/638d2798a130a8e77268b848-public/f13e5463746db5554514e16b0804ce41.png",
    "description": "Licensed NSW builder, published author, and 2005 NSW Fair Trading Minister's Award winner with over 40 years in Australian residential construction. Developer of ABE Education's directly delivered owner builder (QLD, WA, TAS, ACT) and CPD courses, completed by more than 31,000 students.",
    "hasCredential": [
      {
...
Implementation notes: inject in the LearnWorlds logged-out custom-code tab; always pair with a separate BreadcrumbList block (Home › Experts › Dominic Ogburn); course pages reference via `reviewedBy` / `author` `@id` without duplicating the Person object; `image` must match the Headshot URL property; `sameAs` is an array.
...
- ❌ *Your Home: 99 Q&As From The Experts* (wrong title)
