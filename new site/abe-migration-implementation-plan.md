...
**Wave 3** — ☑ W3-1 ◪ W3-2 ◪ W3-3 ◪ W3-4 ☐ W3-5 ☐ W3-6 *(**W3-3 `/white-card-qld` built 3 Aug 2026**,
...
("Tasmanian residents only") is now known to be unsourced to either the regulator or the Regulations,
flagged `[build]`, not yet fixed. That session also unblocked both W3-5 and W3-6.
