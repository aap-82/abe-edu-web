# 01 — Source map and fact ledger — /cpd-plumbing-tas
...
| Bundle membership and point count (13 live courses) | `kb/register/cpd/tas-courses.json`, the `bundles` array filtered to live status | synced 27 Jul 2026 |
| Completion time | `business data/LearnWorlds/tas-cpd-course-metrics-jul-2026.md` | Jul 2026 snapshot |
| Price $499 | Andrey, recorded in `handover/HANDOVER-cpd-bundles.md` | 25 Jul 2026 |
