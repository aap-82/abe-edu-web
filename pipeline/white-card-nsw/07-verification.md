...
```
before: Book a session → Attend live online → Pass the assessment → Work on your statement
after:  Book|a session → Attend|live online → Pass|the assessment → Work on|your statement
```
