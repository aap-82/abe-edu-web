...
1 step bodies in the "how it works" ladder changed on this page:

  - "Blue Dog issues your Statement of Attainment"
...
Same "Your RTO partner" drop as white-card-act, and the same finding: the RTO name and number
survive, and a step body is not one of the seven mandated disclosure locations.
...
```
before: Enrol → Complete online → Pass the video assessment → Lodge for your card
after:  Enrol → Complete|online → Pass|the video assessment → Lodge|for your card
```
